  ...
  return (
    ...
    <div className='bg text-center'>
        ...
        <div className='d-flex justify-content-center mt-5 pt-5'>
            <Link to='/contactus' onClick={() => window.scrollTo(0, 0)}><button className='btn btn-light mb-5'>TALK TO US</button></Link>
        </div>
    </div>
    ...
    <div className='customer mt-5'>
      ...
      <div><Link to='/contactus' onClick={() => window.scrollTo(0, 0)}><button className='hi btn btn-light mb-5 mt-5'>TALK TO US</button></Link></div>
    </div>
    </>
  )
}
